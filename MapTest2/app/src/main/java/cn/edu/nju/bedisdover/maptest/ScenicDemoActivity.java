 ...
 * 以黄龙潭为例
 */
public class ScenicDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scenic_demo);
    ...
    private void init() {
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!start) {
                    SpeechUtil.startSpeaking(v.getContext(), scenic.getDescription());
